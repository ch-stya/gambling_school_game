...
img_rock_card = pygame.image.load("Images/Cards/rock_card(170x220).png") 
img_rock_card.convert_alpha() 
img_back_card = pygame.image.load("Images/Cards/back_cards(170x220).png") 
img_back_card.convert_alpha() 
img_scissors_card = pygame.image.load("Images/Cards/scissors_card(170x220).png") 
img_scissors_card.convert_alpha() 
img_paper_card = pygame.image.load("Images/Cards/paper_card(170x220).png") 
img_paper_card.convert_alpha() 
img_yumeko = pygame.image.load("Images/yumeko(3)(300x250).png")
img_yumeko.convert_alpha()
img_saotome = pygame.image.load("Images/saotome_pretty(240x320).png")
img_saotome.convert_alpha()
img_fond = pygame.image.load("Images/Fonds/fond(1).jpg")
img_validate_button = pygame.image.load("Images/valid_icon(100x100).png")
